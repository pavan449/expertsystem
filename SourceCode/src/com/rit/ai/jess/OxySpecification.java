...
public class OxySpecification {
	...
	public void populate(DissolvedOxy dissolvedOxy, Node node) {
		populateRateOfChange(dissolvedOxy.getValues());
		populateTimeCalibrationMiliSecond(dissolvedOxy, node);
		populateTimeMaintainceMiliSecond(dissolvedOxy, node);
	}


	private void populateTimeMaintainceMiliSecond(DissolvedOxy dissolvedOxy, Node node) {
	...
	private void populateTimeCalibrationMiliSecond(DissolvedOxy dissolvedOxy, Node node) {
