...
public class SalSpecification {

	float rateOfChange;
	float timeCalibrationMiliSecond;
	float timeMaintainceMiliSecond;
	
	private float thresholdForROC = 0.3f;
	private long thresholdForCAL  = 1800;
	private long thresholdForMNT = 2000;
	...
	public void populate(Salinity salinity, Node node) {
		populateRateOfChange(salinity.getValues());
		populateTimeCalibrationMiliSecond(salinity, node);
		populateTimeMaintainceMiliSecond(salinity, node);
	}


	
	private void populateTimeMaintainceMiliSecond(Salinity salinity, Node node) {
	...
	private void populateTimeCalibrationMiliSecond(Salinity salinity, Node node) {
	...
	private void populateRateOfChange(List<Float> values) {
