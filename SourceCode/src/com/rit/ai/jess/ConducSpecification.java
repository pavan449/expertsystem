...
public class ConducSpecification {
	...
	public void populate(Conductivity conductivity, Node node) {
		populateRateOfChange(conductivity.getValues());
		populateTimeCalibrationMiliSecond(conductivity, node);
		populateTimeMaintainceMiliSecond(conductivity, node);
	}


	
	private void populateTimeMaintainceMiliSecond(Conductivity conductivity, Node node) {
	...
	private void populateTimeCalibrationMiliSecond(Conductivity conductivity, Node node) {
