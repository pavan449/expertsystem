...
public class PHSpecificaion {
	...
	public void populate(PH ph, Node node) {
		populateRateOfChange(ph.getValues());
		populateTimeCalibrationMiliSecond(ph, node);
		populateTimeMaintainceMiliSecond(ph, node);
	}


	
	private void populateTimeMaintainceMiliSecond(PH ph, Node node) {
	...
	private void populateTimeCalibrationMiliSecond(PH ph, Node node) {
